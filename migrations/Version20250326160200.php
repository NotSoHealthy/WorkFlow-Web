 ...
 */
final class Version20250326160200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application DROP FOREIGN KEY fk_application_user');
        $this->addSql('ALTER TABLE application DROP FOREIGN KEY application_ibfk_1');
        ...
        $this->addSql('ALTER TABLE application ADD CONSTRAINT fk_application_user FOREIGN KEY (user) REFERENCES user (id)');
        $this->addSql('ALTER TABLE application ADD CONSTRAINT application_ibfk_1 FOREIGN KEY (job) REFERENCES job_offer (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE project DROP FOREIGN KEY fk_department');
        $this->addSql('ALTER TABLE project CHANGE Name name VARCHAR(255) NOT NULL, CHANGE Description description VARCHAR(255) NOT NULL, CHANGE State state VARCHAR(255) DEFAULT NULL, CHANGE Department Department INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP FOREIGN KEY FK_2FB3D0EE8240E25A');
        $this->addSql('ALTER TABLE project CHANGE name Name VARCHAR(20) NOT NULL, CHANGE description Description VARCHAR(60) NOT NULL, CHANGE state State VARCHAR(20) DEFAULT NULL, CHANGE Department Department INT NOT NULL');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT fk_department FOREIGN KEY (Department) REFERENCES department (id) ON UPDATE CASCADE ON DELETE CASCADE');
